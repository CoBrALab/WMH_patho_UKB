...
dir.create("./results/parcnofill_correlate_patterns", showWarnings=FALSE)
dir.create("./visualization/parcnofill_correlate_patterns", showWarnings=FALSE)

# Load data

df_ukb_dx = as.data.frame(fread("./results/parcnofill_UKB_disorders/WMH_diff_UKB_icd10.tsv"))

df_ukb_prs = as.data.frame(fread("./results/parcnofill_UKB_PRS/WMH_diff_UKB_PRS.tsv"))

df_adni_dx = as.data.frame(fread("./results/parcnofill_ADNI_dx/WMH_diff_ADNI_dx.tsv"))

df_adni_abplus = as.data.frame(fread("./results/parcnofill_ADNI_dx/WMH_diff_ADNI_abplus.tsv"))
...
fwrite(results_corr, "./results/parcnofill_correlate_patterns/effects_pattern_correlations.tsv", row.names=FALSE, col.names=TRUE, quote=FALSE, sep="\t")
...
ggsave("./visualization/parcnofill_correlate_patterns/corr_matrix_clust_dend.png", width=7, height=9)
